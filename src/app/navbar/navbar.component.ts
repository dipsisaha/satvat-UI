...
export class NavbarComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any,private serviceInstance: NavbarService, private router: Router,private data: DataService,private sidepanelService: SidePanelService,private commonService: CommonService) {

...
export class SpinnerComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal,private commonService:CommonService,private authService: AuthenticationService,private prodService: ProductService) { 
    ...
    prodService.spinner.subscribe(state=>{
    ...
    // empService.spinner.subscribe(state=>{
    //   console.log("auth spinner captured");
    //   if(state==true){
    //     this.openSpinner();
    //   }
